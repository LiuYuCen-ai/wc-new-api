...
export const STATIC_I18N_KEYS = [
  ...
  // Home hero carousel
  'Unified access to next-gen AI image models',
  'New API Image Gateway',
  'Aggregate Gemini, GPT Image, and more image models through one compatible endpoint to build stable, observable, cost-efficient generation services faster.',
  'Ship high-quality image generation faster',
  'GPT Image Ready',
  'Cover production scenarios like text-to-image, image editing, and batch generation with key management, request logs, and stable routing built in.',
  'High-concurrency visual APIs for business',
  'Gemini Flash Image',
  'Automatically select available channels to reduce failures caused by provider volatility, so teams can focus on product experience instead of model integration.',
  'Unified auth',
