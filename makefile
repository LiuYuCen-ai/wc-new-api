...
.PHONY: all build-frontend build-frontend-classic build-all-frontends start-backend dev dev-api dev-api-rebuild dev-web dev-web-classic reset-setup sync-upstream
...
sync-upstream:
	@chmod +x ./scripts/sync-upstream-daily.sh
